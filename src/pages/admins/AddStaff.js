...
import '../../assets/css/admins/AddStaff.css'
...
function AddStaff() {
    ...
    const handleSignUp = () => {
        setError(null)
        setLoading(true)
        axios.post('https://njc-school-portal.herokuapp.com/api/v1/staff/register',
            {
                ...
                <div className="signup__container">
                    <div className="signup__right">
                        ...
                        <div className="signup__card">
                            ...
                            <input className="signup__btn" type="button" value={loading ? 'Loading...' : 'Add Staff'} onClick={handleSignUp} disabled={loading} /><br />
