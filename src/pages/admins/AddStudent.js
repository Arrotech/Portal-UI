...
function AddStudent() {
    ...
    const handleSignUp = () => {
        setError(null)
        setLoading(true)
        axios.post('https://njc-school-portal.herokuapp.com/api/v1/students/register',
            {
                ...
                <div className="signup__container">
                    <div className="signup__right">
                        ...
                        <div className="signup__card">
                            ...
                            <input className="signup__btn" type="button" value={loading ? 'Loading...' : 'Add Student'} onClick={handleSignUp} disabled={loading} /><br />
